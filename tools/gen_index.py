...
SDK_LABEL = {"claude_sdk": "Claude SDK", "claude_skill": "Claude Skills", "openai_sdk": "OpenAI SDK", "google_adk": "Google ADK", "mcp": "MCP", "langchain": "LangChain", "crewai": "CrewAI", "autogen": "AutoGen", "vercel_ai": "Vercel AI", "pydantic_ai": "Pydantic AI"}
SDK_FULL = {
...
def build_master(rules: list[RuleSpec]) -> str:
    ...
    # Totals table
    # Columns are derived from SCOPE_ORDER rather than listed here, so adding a
    # scope cannot leave the totals table silently short a column.
