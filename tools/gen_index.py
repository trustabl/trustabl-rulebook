...
SDK_ORDER = ["claude_sdk", "claude_skill", "openai_sdk", "google_adk", "mcp", "langchain", "crewai", "autogen", "vercel_ai", "pydantic_ai"]
SDK_LABEL = {"claude_sdk": "Claude SDK", "claude_skill": "Claude Skill", "openai_sdk": "OpenAI SDK", "google_adk": "Google ADK", "mcp": "MCP", "langchain": "LangChain", "crewai": "CrewAI", "autogen": "AutoGen", "vercel_ai": "Vercel AI", "pydantic_ai": "Pydantic AI"}
SDK_FULL = {
    "claude_sdk": "Claude Agent SDK",
    "claude_skill": "Claude Agent Skills",
...
SCOPE_ORDER = ["tool", "agent", "subagent", "skill", "repo"]
...
def build_master(rules: list[RuleSpec]) -> str:
    ...
    # Totals table. Columns are derived from SCOPE_ORDER rather than hardcoded, so
    # adding a scope to the pack cannot leave the table silently short a column.
    ...
    for cat in SDK_ORDER:
        ...
        totals_rows.append(
            [SDK_FULL[cat], *(str(b[s]) for s in SCOPE_ORDER), str(len(cr)), link]
        )
    totals_rows.append(
