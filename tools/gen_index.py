...
SDK_ORDER = ["claude_sdk", "openai_sdk", "google_adk", "mcp", "langchain"]
SDK_LABEL = {"claude_sdk": "Claude SDK", "openai_sdk": "OpenAI SDK", "google_adk": "Google ADK", "mcp": "MCP", "langchain": "LangChain"}
SDK_FULL = {
